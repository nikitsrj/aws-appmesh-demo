...
aws appmesh create-virtual-service --cli-input-json file://V1/order/order-vs.json
...
aws appmesh create-virtual-service --cli-input-json file://V1/product/product-vs.json
...
aws appmesh create-virtual-service --cli-input-json file://V1/customer/customer-vs.json
