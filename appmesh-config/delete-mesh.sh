...
aws appmesh delete-virtual-service --mesh-name shopmesh --virtual-service-name product.default.svc.cluster.local
aws appmesh delete-virtual-service --mesh-name shopmesh --virtual-service-name customer.default.svc.cluster.local
aws appmesh delete-virtual-service --mesh-name shopmesh --virtual-service-name order.default.svc.cluster.local
